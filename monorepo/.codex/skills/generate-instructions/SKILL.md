...
description: "Analyze a monorepo directory and generate an AGENTS.md file with context for Codex"
---

# Generate AGENTS.md File

Analyze a specific directory in the monorepo and create an `AGENTS.md` file
with context for Codex.

## Inputs
1. **Target Directory** (required) - The directory path to analyze
   (e.g., `packages/api`, `apps/web`)

## Output
Create an `AGENTS.md` file in the target directory with all 7 sections
populated.

## Steps
1. **Analyze the Directory** - Examine code structure, patterns, and
   conventions
2. **Generate AGENTS.md** - Create the file with all sections
