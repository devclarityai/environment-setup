...
- The JSON file should be saved in the current working directory or a specified
  location

## Questions to Ask
1. "I found X directories. Should I include all of them or would you like to
